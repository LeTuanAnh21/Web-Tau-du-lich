<?php  
    ...
    if(isset($_POST['submit'])){
		...
		if (isset($email)&&isset($dc)&&isset($gt)&&isset($ht)&&isset($cmnd)&&isset($sdt)&&isset($id)&&isset($mat_khau)&&isset($quyen_truy_cap)) {
            move_uploaded_file($tmp_name, 'anh/'.$anh_sp);
			$sql="UPDATE thanhvien SET email='$email',dc='$dc',ht='$ht',quyen_truy_cap='$quyen_truy_cap',mat_khau='$mat_khau',gt='$gt',cmnd='$cmnd',sdt='$sdt',anh_sp='$anh_sp',"."id='$id' WHERE id_thanhvien=$id_thanhvien";
            $query = mysqli_query($conn,$sql);
                    ...
                    <div class="col-md-6">
                         ...
                         <div class="form-group">
                            ...
                            <label>Quyền Truy Cập</label>
                                ...
                                <option <?php if($row["quyen_truy_cap"]==2){echo "selected";}?> value=2>ADMIN</option>
                                <option <?php if($row["quyen_truy_cap"]==1){echo "selected";}?> value=1>NHÂN VIÊN</option>
