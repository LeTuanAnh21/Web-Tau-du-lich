<?php  
    ...
    if(isset($_POST['submit'])){
		...
		if (isset($id)&&isset($ten)) {
			$sql="UPDATE bangcap SET ten='$ten' WHERE id=$id";
            $query = mysqli_query($conn,$sql);
...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">CẬP NHẬT THÔNG TIN BẰNG CẤP</h1>
    </div>
</div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                  ...
                  <a href="quantri.php?page_layout=quanlybc"><input type="button" value="Quay Lại" class="btn btn-default" /></a>							
                </div>
                </form>
            </div>
        </div>
